...
const routes = [
  ...
  // 求职者
  {
    ...
    children: [
      ...
      { path: 'search', name: 'SearchJobs', component: () => import('@/views/candidate/SearchJobs.vue'), meta: { title: '职位全文搜索' } },
  ...
  // HR
  {
    ...
    children: [
      ...
      { path: 'candidates', name: 'CandidateList', component: () => import('@/views/hr/CandidateList.vue'), meta: { title: '候选人管理' } },
      { path: 'talent-pool', name: 'TalentPool', component: () => import('@/views/hr/TalentPool.vue'), meta: { title: '候选人才库' } },
